 ...
 * @author sudipto
 */
public final class CockroachDBCreateTable {
  ...
  private static void createTable(Properties props, String tablename) throws SQLException {
    String driver = props.getProperty(CockroachDBClient.DRIVER_CLASS);
    String username = props.getProperty(CockroachDBClient.CONNECTION_USER);
    String password = props.getProperty(CockroachDBClient.CONNECTION_PASSWD, "");
    String url = props.getProperty(CockroachDBClient.CONNECTION_URL);
    int fieldcount = Integer.parseInt(props.getProperty(CockroachDBClient.FIELD_COUNT_PROPERTY,
        CockroachDBClient.FIELD_COUNT_PROPERTY_DEFAULT));
  ...
  public static void main(String[] args) {
    ...
    if (fieldcount > 0) {
      props.setProperty(CockroachDBClient.FIELD_COUNT_PROPERTY, String.valueOf(fieldcount));
    }
   ...
   * Hidden constructor.
   */
  private CockroachDBCreateTable() {
    super();
  }
}
